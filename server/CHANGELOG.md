...
### Fixed
  ...
  - fix server not starting with theia 1.66.
...
[unreleased]: https://github.com/perrinjerome/vscode-zc-buildout/compare/v0.17.2...main
[0.17.2]: https://github.com/perrinjerome/vscode-zc-buildout/compare/v0.17.1...v0.17.2
